...
public final class Constants {
    ...
    public static final String WRONG_EMAIL = "em.com";

    public static final String PASSWORD = "Password1";

    public static final String WRONG_PASSWORD = "Pass1";

    public static final String NAME = "Joe";

    public static final String WRONG_NAME = "";

    public static final String SURNAME = "Yi";

    public static final String WRONG_SURNAME = "";

    public static final String SPEAKER_NAME = "Joe Yi";

    public static final boolean NOTIFICATION = false;

    public static final String ROLE_NAME = "VISITOR";
