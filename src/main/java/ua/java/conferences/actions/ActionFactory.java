...
public final class ActionFactory {
    ...
    static {
        ...
        ACTION_MAP.put("about", new AboutAction());
        ACTION_MAP.put("contacts", new ContactsAction());
        ACTION_MAP.put("sign-in-page", new SignInPageAction());
        ACTION_MAP.put("sign-in", new SignInAction());
        ACTION_MAP.put("sign-up", new SignUpAction());
        ACTION_MAP.put("sign-up-page", new SignUpPageAction());
        ...
        ACTION_MAP.put("reset-password-page", new PasswordResetPageAction());
