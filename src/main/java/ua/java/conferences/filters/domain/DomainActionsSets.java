...
public final class DomainActionsSets {
    ...
    static {
        ...
        VISITOR_ACTIONS.add(VIEW_UP_EVENTS_BY_VISITOR_ACTION);
        VISITOR_ACTIONS.add(VIEW_VISITORS_EVENTS_ACTION);
        VISITOR_ACTIONS.add(VIEW_EVENT_BY_VISITOR_ACTION);
        VISITOR_ACTIONS.add(REGISTER_FOR_EVENT_ACTION);
        VISITOR_ACTIONS.add(CANCEL_REGISTRATION_ACTION);
    }
    ...
    static {
        ...
        SPEAKER_ACTIONS.add(SET_SPEAKER_BY_SPEAKER_ACTION);
        SPEAKER_ACTIONS.add(REMOVE_SPEAKER_BY_SPEAKER_ACTION);
    }
